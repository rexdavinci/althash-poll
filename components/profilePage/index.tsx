    ...
    <div className="mt-12">
      <div className="w-8/12 mx-auto">
        <div className="text-center">
          <img className="md:h-36 border-8 border-black mx-auto" src={profile.image} alt={profile.name}/>
          <p className="text-white text-2xl">{profile.name.toUpperCase()}</p>
          <p className="text-white">ELECTOR NUMBER {profile.electorNumber}</p>
        </div>
      </div>
